...
\begin{minipage}{\linewidth}
Input to digtick:
\begin{sourcebox}\texttt{F\_7 !F\_4 !F\_2 + F\_4 F\_1 !F\_0 + !<F\_2 F\_3>}\end{sourcebox}
Default rendering:
\begin{renderedbox}$\mathrm{F_7 \overline{F_4}\,\overline{F_2} \vee F_4 F_1 \overline{F_0} \vee \overline{F_2 F_3}}$\end{renderedbox}
Using math operators:
\begin{renderedbox}$\mathrm{F_7 \neg F_4 \neg F_2 \vee F_4 F_1 \neg F_0 \vee \neg (F_2 F_3)}$\end{renderedbox}
\end{minipage}
\vspace{2cm}
